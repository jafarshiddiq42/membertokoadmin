                ...
                function (t, e, s) {
                    ...
                    const d = function (t) {
                        ...
                        c = {
                            ...
                            labels: {
                                ...
                                perPage: "{select} Tampilan data per halaman",
                                noRows: "Data tidak ditemukan",
                                noResults: "Tidak ada hasil yang sesuai dengan pencarian",
                    ...
                    class u {
                        ...
                        render(t) {
                            ...
                            if (e.searchable) {
                                const t = `<div class='dataTable-search'><input class='dataTable-input form-control form-control-sm' placeholder='${e.labels.placeholder}' type='text'></div>`;
